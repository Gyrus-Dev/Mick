...
import logging
from src.postgres_ai.objagents._spinner import spinner
from src.postgres_ai.telemetry import tracer, agent_invocations

logger = logging.getLogger(__name__)

# Stores in-flight spans keyed by agent name.
# Safe without locks — postgresai enforces sequential (non-parallel) agent execution.
